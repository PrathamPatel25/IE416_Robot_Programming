...
"""autogenerated by genpy from alexa_ros/AlexaTaskActionResult.msg. Do not edit."""
import codecs
import sys
...
class AlexaTaskActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "alexa_ros/AlexaTaskActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','alexa_ros/AlexaTaskResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AlexaTaskActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = alexa_ros.msg.AlexaTaskResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = alexa_ros.msg.AlexaTaskResult()
