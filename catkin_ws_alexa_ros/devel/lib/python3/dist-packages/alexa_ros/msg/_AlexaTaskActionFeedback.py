...
"""autogenerated by genpy from alexa_ros/AlexaTaskActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class AlexaTaskActionFeedback(genpy.Message):
  _md5sum = "26ada9951e65c9839ccf69133eb30b40"
  _type = "alexa_ros/AlexaTaskActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','alexa_ros/AlexaTaskFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AlexaTaskActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = alexa_ros.msg.AlexaTaskFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = alexa_ros.msg.AlexaTaskFeedback()
